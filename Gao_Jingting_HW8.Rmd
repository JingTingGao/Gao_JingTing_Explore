...
explore <- function(dataframe, plotswitch = "off", threshold = 0, vector = NULL) {
...
#Subfunctions:
plot_density_count(dataframe,plotswitch,vector) #plot the density and count histograms

plot_gray (dataframe, plotswitch) #plot gray bar for every categorial and binary variable
...
plot_density_count <- function(dataframe,plotswitch = 'off',vector = NULL){
...
plot_gray <- function(dataframe, plotswitch='off') {
...
dfm_cb <- dataframe[,sapply(dataframe,is.factor)|sapply(dataframe,is.logical)|sapply(dataframe,is.binary)] 
